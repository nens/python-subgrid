...
- Fill in a short description on https://github.com/lizardsystem/python-subgrid or
  https://github.com/nens/python-subgrid if you haven't done so already.
...
- Check https://github.com/nens/python-subgrid/settings/collaboration if the team
  "Nelen & Schuurmans" has access.

- Add a new jenkins job at
  http://buildbot.lizardsystem.nl/jenkins/view/djangoapps/newJob or
  http://buildbot.lizardsystem.nl/jenkins/view/libraries/newJob . Job name
  should be "python-subgrid", make the project a copy of the existing "lizard-wms"
  project (for django apps) or "nensskel" (for libraries). On the next page,
  change the "github project" to ``https://github.com/nens/python-subgrid/`` and
  "repository url" fields to ``git@github.com:nens/python-subgrid.git`` (you might
